...
If You Want Any **Other Shortner** Link Converter Bot Instead Of Tulinks than **contact** at 👉 @abhi_the_machinegun (all **shortners** support available.)
'''
...
ABOUT_TEXT = '''**Hey! My name is Tulinks.one. I am Shortener Link Converter Bot.**
...
Ex: https://t.me/tulinks_official | Tulinks"""
...
START_MESSAGE_REPLY_MARKUP  = InlineKeyboardMarkup([
    [
        InlineKeyboardButton('Get Api', url=f'https://Tulinks.one/member/tools/api')
    ]
])
...
USER_ABOUT_MESSAGE = """
- Website: [{base_site}](https://tulinks/ref/rngharman)
...
Get API From [{base_site}](https://tulinks/ref/rngharman)
...
USERNAME_TEXT = """**Hello Harman, I am tulinks.one, Bulk Link Converter Bot From Linked tulinks.one Account,**

**🌟 Type** /channel (channel link or username)

**example:**
/channel @tulinks_official
Or
/channel https://t.me/tulinks_official

**🤘 Hit** 👉 /features To Know More Features Of This Bot.

**- Message @abhi_the_machinegun For More Help -**"""
